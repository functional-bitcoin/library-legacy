...
describe('bcat/file', () => {
  describe('with full args', () => {
    const args = ['add.bico.media', 'video/mp4', 'binary', 'Top Gun I feel the need... the need for speed!.mp4', ''],
          parts = [ '76d0361a383b00f5584c9e8fcbc6a5eb18e6cc9dcd948f8bcc272f0b4122753c',
    ...
    const script = createTestScript('bcat/file', args)
